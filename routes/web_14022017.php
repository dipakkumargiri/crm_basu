...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            //Route::get('/inquiryList',['uses' => 'SuperAdminPackageController@inquiryList'])->name('packages.inquiryList');
            ...
            Route::get('/inquiryDetails/{dBIdId}', ['uses' => 'SuperAdminPackageController@inquiryDetails'])->name('packages.inquiryDetails');
            Route::get('/deleteInquiry/{dBIdId}', ['uses' => 'SuperAdminPackageController@deleteInquiry'])->name('packages.deleteInquiry');
            Route::get('/deleteAll', ['uses' => 'SuperAdminPackageController@deleteAll'])->name('packages.deleteAll');
           // Route::delete('deleteAll', 'SuperAdminPackageController@deleteAll');
            //Route::get('inquiry/deleteAll', 'SuperAdminPackageController@deleteAll')->name('packages.deleteInquiryAll');
    ...
    Route::group(
        ...
        function () {
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                Route::get('/inquiryList', 'AdminDashboardController@inquiryList')->name('inquiryList');
                Route::get('/inquiryDetails/{dBIdId}', 'AdminDashboardController@inquiryDetails')->name('inquiryDetails');
                Route::get('/deleteInquiry/{dBIdId}','AdminDashboardController@deleteInquiry')->name('deleteInquiry');
                Route::post('/deleteAll', 'AdminDashboardController@deleteAll')->name('deleteAll');
                Route::post('/deleteAllClientDatabase', 'AdminDashboardController@deleteAllClientDatabase')->name('deleteAllClientDatabase');
                //Route::get('deleteAll', [AdminDashboardController::class, 'deleteAll']);
                //Route::get('/viewDetails/{dBIdId}', ['uses' => 'SuperAdminPackageController@viewDetails'])->name('packages.viewDetails');
                ...
                Route::post('projectMarketing/store-cat', ['uses' => 'ManageProjectMarketingStatusController@storeCat'])->name('projectMarketing.store-cat');
                Route::get('projectMarketing/create-cat', ['uses' => 'ManageProjectMarketingStatusController@createCat'])->name('projectMarketing.create-cat');
                Route::resource('projectMarketing', 'ManageProjectMarketingStatusController');
    ...
    Route::group(
        ...
        function () {
           ...
           Route::get('/quick-create/{id}', ['uses' => 'MemberClientsController@quickCreate'])->name('quick-create');
           Route::post('client-docs-store', ['uses' => 'MemberClientsController@clientDocstore'])->name('client-docs-store');
           Route::get('/clientquestion/{id}', ['uses' => 'MemberClientsController@clientquestion'])->name('clientquestion');
           Route::get('/quickCreateQuestion/{id}', ['uses' => 'MemberClientsController@quickCreateQuestion'])->name('quickCreateQuestion');
           Route::put('clients_update/{id}', ['uses' => 'MemberClientsController@clients_update'])->name('clients_update');
           Route::get('/show_buyer/{id}', ['uses' => 'MemberClientsController@show_buyer'])->name('show_buyer');
           Route::get('/edit_buyer/{id}', ['uses' => 'MemberClientsController@edit_buyer'])->name('edit_buyer');
           Route::get('buyer_doucument/{id}', ['uses' => 'MemberClientsController@buyer_doucument'])->name('buyer_doucument');
           Route::put('/update_buyer/{id}', ['uses' => 'MemberClientsController@update_buyer'])->name('update_buyer');
