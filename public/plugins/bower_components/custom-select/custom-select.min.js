    ...
    (function (a, b) {
        ...
        if (window.Select2 === b) {
            ...
            (i = a(document)),
                ...
                (c = O(Object, {
                    ...
                    init: function (c) {
                        ...
                        (this.opts = c = this.prepareOpts(c)),
                            ...
                            0 == this.liveRegion.length && (this.liveRegion = a("<span>", { role: "status", "aria-live": "polite" }).addClass("select2-hidden-accessible").appendTo(document.body)),
                    ...
                    monitorSource: function () {
                        ...
                        c.on(
                            ...
                            (this._sync = this.bind(function () {
                                ...
                                d === b && (d = !1),
                                    this.readonly(d),
                                    this.container && (D(this.container, this.opts.element, this.opts.adaptContainerCssClass), this.container.addClass(K(this.opts.containerCssClass, this.opts.element))),
                                    this.dropdown && (D(this.dropdown, this.opts.element, this.opts.adaptDropdownCssClass), this.dropdown.addClass(K(this.opts.dropdownCssClass, this.opts.element)));
                            })),
                            c.length &&
                                c[0].attachEvent &&
                                c.each(function () {
                    ...
                    positionDropdown: function () {
                        ...
                        u ? ((w = !0), !q && p && ((x = !0), (w = !1))) : ((w = !1), !p && q && ((x = !0), (w = !0))),
                            ...
                            (y = { left: o, width: f }),
                            w
                                ? ((y.top = d.top - g), (y.bottom = "auto"), this.container.addClass("select2-drop-above"), b.addClass("select2-drop-above"))
                                : ((y.top = n), (y.bottom = "auto"), this.container.removeClass("select2-drop-above"), b.removeClass("select2-drop-above")),
                    ...
                    updateResults: function (c) {
                        function m() {
                            d.removeClass("select2-active"),
                                ...
                                e.find(".select2-no-results,.select2-selection-limit,.select2-searching").length
                                    ...
                                    : h.liveRegion.text(h.opts.formatMatches(e.find('.select2-result-selectable:not(".select2-selected")').length));
                        }
                        function n(a) {
                            e.html(a), m();
                        }
                        ...
                        if ((c === !0 || !k || !r(j, k)) && (a.data(this.container, "select2-last-term", j), c === !0 || (this.showSearchInput !== !1 && this.opened()))) {
                            ...
                            if (d.val().length < f.minimumInputLength)
                                return (
                                    J(f.formatInputTooShort, "formatInputTooShort") ? n("<li class='select2-no-results'>" + K(f.formatInputTooShort, f.element, d.val(), f.minimumInputLength) + "</li>") : n(""),
                                        ...
                                        if (l == this.queryCount) {
                                            ...
                                            e.empty(),
                                                ...
                                                g.more === !0 &&
                                                    ...
                                                    (e.append("<li class='select2-more-results'>" + f.escapeMarkup(K(f.formatLoadMore, f.element, this.resultsPage)) + "</li>"),
                                                    window.setTimeout(function () {
                                                        h.loadMoreIfNeeded();
                                                    }, 10)),
                    ...
                    postprocessResults: function (a, b, c) {
                        ...
                        e.each2(function (a, b) {
                            ...
                            !this.opts.createSearchChoice &&
                                ...
                                this.results.append("<li class='select2-no-results'>" + K(g.opts.formatNoMatches, g.opts.element, g.search.val()) + "</li>");
                    },
                ...
                (window.Select2 = { query: { ajax: G, local: H, tags: I }, util: { debounce: w, markMatch: E, escapeMarkup: F, stripDiacritics: o }, class: { abstract: c, single: d, multi: e } });
        }
    })(jQuery);
