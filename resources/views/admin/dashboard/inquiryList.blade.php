...
@section('page-title')
    <div class="row bg-title">
        <div class="col-lg-8 col-md-5 col-sm-6 col-xs-12 bg-title-left">
            <h4 class="page-title"><i class="icon-people"></i> @lang('app.inquiry')
                <span class="text-info b-l p-l-10 m-l-5">{{ $totalLeads }}</span> <span
                        class="font-12 text-muted m-l-5">@lang('app.total_inquiry')</span>
            </h4>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="white-box">
                ...
                <button style="margin-bottom: 10px" disabled class="btn btn-primary1 delete_all" id="deleteAll" data-url="{{ url('admin/deleteAll') }}">Delete All</button>
                            ...
                            <tr id="tr_{{$client->id}}">
                                   <td><input type="checkbox" class="sub_chk" data-id="{{$client->id}}"></td>
                                    <th>{{$client->clint_name}}</th>
                                     ...
                                     <th><a title="View" href="{{ route('admin.inquiryDetails',$client->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                     <a href="{{ route('admin.deleteInquiry',$client->id) }}" onclick="return confirm('Are you sure?')" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a>
                                     </th>
                                     </tr>
                                     <?php $i++; ?>
                            @endforeach
