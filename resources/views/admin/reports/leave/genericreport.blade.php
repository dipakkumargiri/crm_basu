            ...
            <div class="col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                             <button type="button"  class="btn btn-success col-md-offset-1" id="exportUserData"><i class="fa fa-file-excel-o" aria-hidden="true"></i> @lang('app.dealsExport')</button>
                         </div>
                         </br>
                         </br>
                        <div class="col-xs-12">
                               <button type="button"  class="btn btn-inverse col-md-offset-1" id="bagent"><i class="fa fa-file-excel-o" aria-hidden="true"></i> @lang('app.buyerAgentDetails')</button>
         
                         </div>
                         </br>
                         </br>
                        <div class="col-xs-12">
                               <button type="button"  class="btn btn-success col-md-offset-1" id="sagent"><i class="fa fa-file-excel-o" aria-hidden="true"></i> @lang('app.selerAgentDetails')</button>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable"
                        ...
                        <tr>
                            ...
                            <th>@lang('app.buyerAgiantName')</th>
