...
<script>
    ...
    $('#createProject').on('click', '#addProjectMarketing', function () {
        var url = '{{ route('admin.projectMarketing.create-cat')}}';
        $('#modelHeading').html('Manage Project Marketing Status');
        $.ajaxModal('#projectCategoryModal', url);
    })
    ...
    <?php /*var categories = @json($industries);
