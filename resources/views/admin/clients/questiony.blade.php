                                        ...
                                        <div class="row">
                                            <div class="col-xs-12" >
                                                <button class="btn btn-sm btn-info addDocs m-t-10 m-b-10 " style="" onclick="showAdd()"><i
                                                            ...
                                                            <a class="btn btn-sm btn-info addDocs m-t-10 m-b-10 " href="https://anglobalindia.com/user-uploads/Questionnaires.xls">Sample File</a>
...
@push('footer-script')
    <script>
        function showAdd() {
            var url = "{{ route('admin.client-docs.quick-create-question', [$client->id]) }}";
        ...
        $('ul.showClientTabs .clientQuestion').addClass('tab-current');
    </script>
@endpush
