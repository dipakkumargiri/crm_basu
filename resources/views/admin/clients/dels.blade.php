...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 bg-title-left">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i>@lang("app.genericreport")</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            <ol class="breadcrumb">
                <li><a href="{{ route('admin.dashboard') }}">@lang("app.genericreport")</a></li>
                <li class="active">@lang("app.genericreport")</li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
...
@section('content')
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    ...
                    <div class="form-group" style="padding-left: 45px;">
                         <button type="button"  class="btn btn-success col-md-5 col-md-offset-1" id="exportUserData"><i class="fa fa-file-excel-o" aria-hidden="true"></i> @lang('app.export')</button>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="white-box">
                <h3 class="box-title">@lang("app.genericreport")</h3>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable"
                        ...
                        <tr>
                            ...
                            <th>@lang('app.buyerCompanyName')</th>
