    ...
    <div class="portlet-body">
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                @forelse($marketingstatus as $key=>$status)
                    <tr id="cat-{{ $status->id }}">
                        <td>{{ $key+1 }}</td>
                        <td>{{ ucwords($status->marketing_status) }}</td>
                        <td><a href="javascript:;" data-cat-id="{{ $status->id }}" class="btn btn-sm btn-danger btn-rounded delete-category">@lang("app.remove")</a></td>
                    </tr>
                @empty
                    <tr>
