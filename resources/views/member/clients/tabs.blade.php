<div class="white-box">
    <nav>
        <ul class="showClientTabs">
            <li class="clientProfile"><a href="{{ route('member.sellerShow', $client->id) }}"><i class="icon-user"></i> <span>@lang('modules.employees.profile')</span></a>
            </li>
            ...
            <li class="clientDocs"><a href="{{ route('member.seller_document_show', $client->id) }}"><i class="icon-docs"></i> <span> CIM document</span></a>
            </li>
            <li class="clientQuestion"><a href="{{ route('member.clientquestion', $client->id) }}"><i class="icon-docs"></i> <span>Seller Questionnaires</span></a>
            </li>
