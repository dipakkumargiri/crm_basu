        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                if ($row->client_id == null || $row->client_id == '') {
                    ...
                    $follow = '<li><a href="' . route('admin.clients.create') . '/' . $row->id . '"><i class="fa fa-user"></i> ' .$client_type. '</a></li>';
                    // __('modules.lead.changeToClient')
                ...
                if ($row->client_id == null && $row->client_id == '') {   
                $action .= '<li><a href="' . route('admin.leads.edit', $row->id) . '"><i class="fa fa-edit"></i> ' . __('modules.lead.edit') . '</a></li>
